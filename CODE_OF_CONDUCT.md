...
Instancias de comportamiento abusivo, acosador o inaceptable de otro modo podrán ser reportadas a los administradores de la comunidad responsables del cumplimiento de forma **privada**, por ejemplo:

- Mensaje privado a [@Hoyuse](https://github.com/Hoyuse) en GitHub.
- DM a un administrador o moderador en el [servidor de Discord de ChurrOS](https://discord.gg/4nAJbbzvd) (sin publicar el incidente en canales públicos).
